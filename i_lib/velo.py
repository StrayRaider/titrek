...
class Velo(Gtk.DrawingArea):
    ...
    def draw_all(self,widget,cr):
        ...
        img_path = os.path.expanduser("./assets/hiz.png")
        ...
        cr.set_font_size(17)
        (x, y, width_1, height, dx, dy) = cr.text_extents("Hız :{}".format(self.text))
        cr.set_font_size(10)
        (x, y, width_2, height, dx, dy) = cr.text_extents("km/s")
        ...
        cr.set_font_size(17)
        cr.show_text("Hız :{}".format(self.text))
