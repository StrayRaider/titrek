...
class Altitude(Gtk.DrawingArea):
    def __init__(self):
    ...
    def draw_all(self,widget,cr):
        ...
        img_path = os.path.expanduser("./assets/height.png")
        ...
        cr.set_font_size(17)
        (x, y, width_1, height, dx, dy) = cr.text_extents("Yükseklik :{}".format(self.text))
        cr.set_font_size(10)
        (x, y, width_2, height, dx, dy) = cr.text_extents("m")
        ...
        cr.set_font_size(17)
        cr.show_text("Yükseklik :{}".format(self.text))
